...
print("nccl.is_available=",torch.cuda.nccl.is_available(torch.randn(1).cuda()))

#秒数指定のために追加
# from diffusers import DiffusionPipeline

# pipeline = DiffusionPipeline.from_pretrained("ucsd-reach/musicldm")

config_path = 'interface\musicldm.yaml'
